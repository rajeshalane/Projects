...
public class ContactInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etName.setText(HelloWorld.contacts.get(index).getName());
        etMail.setText(HelloWorld.contacts.get(index).getEmail());
        etTel.setText(HelloWorld.contacts.get(index).getNumber());

        tvChar.setText(HelloWorld.contacts.get(index).getName().toUpperCase().charAt(0)+"");
        tvName.setText(HelloWorld.contacts.get(index).getName());
        ...
        ivCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String uri="tel:"+HelloWorld.contacts.get(index).getNumber();
        ...
        ivMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL,HelloWorld.contacts.get(index).getEmail());
                startActivity(Intent.createChooser(intent,"Send mail to"+HelloWorld.contacts.get(index).getName()));
            }
        });
            ...
            public void onClick(View view) {
                ...
                dialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Backendless.Persistence.of(Contact.class).remove(HelloWorld.contacts.get(index), new AsyncCallback<Long>() {
                            @Override
                            public void handleResponse(Long response) {
                                HelloWorld.contacts.remove(index);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    HelloWorld.contacts.get(index).setName(etName.getText().toString().trim());
                    HelloWorld.contacts.get(index).setNumber(etTel.getText().toString().trim());
                    HelloWorld.contacts.get(index).setEmail(etMail.getText().toString().trim());
                    showProgress(true);
                    tvLoad.setText("Updating contact...please wait...");
                    Backendless.Persistence.save(HelloWorld.contacts.get(index), new AsyncCallback<Contact>() {
                        @Override
